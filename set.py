...
print(student1.symmetric_difference(student2)) # student1 and student
print(student1.isdisjoint(student2)) # student1 and student2 er common value ache kina check korbe
